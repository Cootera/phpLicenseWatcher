...
if (isset($_POST['update_servers'])) {
    $out = array();
    $code = 0;
    @exec('php /var/www/html/phpLicenseWatcher/license_util.php 2>&1', $out, $code);
    echo "<div style=\"margin:10px 0;\"><pre>Update Server ausgeführt (Exitcode {$code}):\n" . htmlspecialchars(implode("\n", $out)) . "</pre></div>";
}
...
function main_form($alert=null) {
    ...
    foreach($server_list as $i => $server) {
        ...
        case null:
            ...
            break;
        case SERVER_UP:
            $table->update_cell($last_row, 5, array('class'=>"success"));
    ...
    <div id='control_panel'>
        ...
        <form method='post' style='display:inline;'>
            <input type='hidden' name='update_servers' value='1'>
            <button type='submit' class='btn servers-control-panel'>Update Servers</button>
        </form>
